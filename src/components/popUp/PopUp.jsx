        ...
        <section className={styles.modal} onClick={() => setPopUpActive(false)}>
            <div className={styles.modal_content}>
                ...
                <div className={styles.content_text}>
                    ...
                    <p className={styles.content_text__status}>Статус: <span className={styles.content_text__all}>{characterInfo.status}</span></p>
                    ...
                    <p className={styles.content_text__status}>Локация: <span className={styles.content_text__all}>{characterInfo.location?.name}</span></p>
